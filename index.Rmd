...
iris[c(1,2,51,52,101,102), ] %>%
  ...
  flextable::theme_vanilla() %>% # テーマの再設定やら
  flextable::fix_border_issues() # 枠線の修復やらめんどい
```

# ftExtraで見出しを階層化 {#multi-index}
...
```{r ft-separate-header, warning=FALSE, attr.source='style=font-size:.65em;'}
